...
private:
	 ...
	 */
	double annealing(const QVector<int> original, double fitness, double actualFitness, int steps, QVector<int>& novel, bool& solved);
	...
	int m_logicOpInfo;
	//! Individual's counter (annealing routine)
	int m_annCnt;
