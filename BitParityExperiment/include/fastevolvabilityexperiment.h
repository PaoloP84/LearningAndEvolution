...
#ifndef FASTEVOLVABILITYEXPERIMENT_H
#define FASTEVOLVABILITYEXPERIMENT_H
 ...
 * 	                                   The default is 0.1
 */
class FARSA_PLUGIN_API FastEvolvabilityExperiment : public farsa::EvoRobotExperiment
{
	Q_OBJECT
